...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_NAV_MECANUM_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_NAV_MECANUM_CONTROLLER_HPP_
...
using ControllerStateMsg = nav_mecanum_controller::NavMecanumController::ControllerStateMsg;
using ControllerReferenceMsg = nav_mecanum_controller::NavMecanumController::ControllerReferenceMsg;
using ControllerModeSrvType = nav_mecanum_controller::NavMecanumController::ControllerModeSrvType;
...
class TestableNavMecanumController : public nav_mecanum_controller::NavMecanumController
{
  FRIEND_TEST(NavMecanumControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(NavMecanumControllerTest, activate_success);
  FRIEND_TEST(NavMecanumControllerTest, reactivate_success);
  FRIEND_TEST(NavMecanumControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(NavMecanumControllerTest, test_update_logic_fast);
  FRIEND_TEST(NavMecanumControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = nav_mecanum_controller::NavMecanumController::on_configure(previous_state);
...
class NavMecanumControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_nav_mecanum_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_nav_mecanum_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_nav_mecanum_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_nav_mecanum_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableNavMecanumController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_NAV_MECANUM_CONTROLLER_HPP_
