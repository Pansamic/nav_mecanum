...
#include "test_nav_mecanum_controller.hpp"
...
using nav_mecanum_controller::CMD_MY_ITFS;
using nav_mecanum_controller::control_mode_type;
using nav_mecanum_controller::STATE_MY_ITFS;

class NavMecanumControllerTest : public NavMecanumControllerFixture<TestableNavMecanumController>
{
};

TEST_F(NavMecanumControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, update_success)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(NavMecanumControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(NavMecanumControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(NavMecanumControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
