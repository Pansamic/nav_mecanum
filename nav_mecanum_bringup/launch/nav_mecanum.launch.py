...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="nav_mecanum_bringup",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="nav_mecanum_controllers.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="nav_mecanum_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="nav_mecanum.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "robot_controller",
            default_value="nav_mecanum_controller",
